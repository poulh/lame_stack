...
/**
 * Api services for the `RegisteredUser` model.
 */
@Injectable()
export class RegisteredUserApi extends BaseLoopBackApi {
   ...
   *
   * @param {any} id RegisteredUser id
   *
  ...
  public linkRoles(id: any, fk: any, data: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "PUT";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/RegisteredUsers/:id/roles/rel/:fk";
    let _routeParams: any = {
      id: id,
      fk: fk
    };
  ...
  public getAccessTokens(id: any, filter: LoopBackFilter = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/RegisteredUsers/:id/accessTokens";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
  ...
  public countAccessTokens(id: any, where: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/RegisteredUsers/:id/accessTokens/count";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
  ...
  /**
   * Queries roles of RegisteredUser.
   *
   * @param {any} id RegisteredUser id
   *
   * @param {object} filter 
  ...
  /**
   * Counts roles of RegisteredUser.
   *
   * @param {any} id RegisteredUser id
   *
   * @param {object} where Criteria to match model instances
  ...
  public countRoles(id: any, where: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/RegisteredUsers/:id/roles/count";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
  ...
  public changePassword(oldPassword: any, newPassword: any, customHeaders?: Function): Observable<any> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/RegisteredUsers/change-password";
    let _routeParams: any = {};
    let _postBody: any = {
      data: {
  ...
  public setPassword(newPassword: any, customHeaders?: Function): Observable<any> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/RegisteredUsers/reset-password";
    let _routeParams: any = {};
    let _postBody: any = {
      data: {
        newPassword: newPassword
   ...
   * </em>
   */
  public hasRole(name: any, req: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/RegisteredUsers/hasRole";
    let _routeParams: any = {};
    let _postBody: any = {};
    let _urlParams: any = {};
   ...
   * </em>
   */
  public getAuthenticatedUserRoles(req: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
  ...
  /**
   * create or patch user with roles
   *
   * @param {object} data Request data.
   *
   * This method expects a subset of model properties as request parameters.
   ...
   * </em>
   */
  public patchOrCreateWithRoles(credentials: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/RegisteredUsers/patchOrCreateWithRoles";
    let _routeParams: any = {};
    let _postBody: any = {
      credentials: credentials
    };
   ...
   * </em>
   */
  public findByIdAccountRegisteredUsers(id: any, fk: any, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/RegisteredUsers/:id/account/registeredUsers/:fk";
    let _routeParams: any = {
      id: id,
      fk: fk
    };
   ...
   * This method returns no data.
   */
  public destroyByIdAccountRegisteredUsers(id: any, fk: any, customHeaders?: Function): Observable<any> {
    let _method: string = "DELETE";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/RegisteredUsers/:id/account/registeredUsers/:fk";
    let _routeParams: any = {
   ...
   * </em>
   */
  public updateByIdAccountRegisteredUsers(id: any, fk: any, data: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "PUT";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/RegisteredUsers/:id/account/registeredUsers/:fk";
    let _routeParams: any = {
   ...
   * </em>
   */
  public getAccountRegisteredUsers(id: any, filter: LoopBackFilter = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/RegisteredUsers/:id/account/registeredUsers";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
   ...
   * </em>
   */
  public createAccountRegisteredUsers(id: any, data: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/RegisteredUsers/:id/account/registeredUsers";
    let _routeParams: any = {
   ...
   * This method returns no data.
   */
  public deleteAccountRegisteredUsers(id: any, customHeaders?: Function): Observable<any> {
    let _method: string = "DELETE";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/RegisteredUsers/:id/account/registeredUsers";
    let _routeParams: any = {
   ...
   *  - `count` – `{number}` - 
   */
  public countAccountRegisteredUsers(id: any, where: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/RegisteredUsers/:id/account/registeredUsers/count";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
   ...
   * </em>
   */
  public createManyAccountRegisteredUsers(id: any, data: any[] = [], customHeaders?: Function): Observable<any> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/RegisteredUsers/:id/account/registeredUsers";
    let _routeParams: any = {
  ...
  /**
   * @ngdoc method
   * @name sdk.RegisteredUser#getCurrent
   * @methodOf sdk.RegisteredUser
   *
   * @description
   *
  ...
  public getCurrent(filter: LoopBackFilter = {}): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() + "/RegisteredUsers" + "/:id";
   ...
   * call to {@link sdk.RegisteredUser#login} or
   * {@link sdk.RegisteredUser#getCurrent}. Return null when there
   ...
   * call to {@link sdk.RegisteredUser#login}
   *
  ...
  /**
   * @name sdk.RegisteredUser#isAuthenticated
   *
  ...
  /**
   * @name sdk.RegisteredUser#getCurrentId
   *
